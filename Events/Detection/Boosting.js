...
module.exports = {
    ...
    async execute(oldMember, newMember) {
        ...
        .setAuthor({
            name: 'Server BOOTED',
            url: 'https://imgur.com/',
            iconURL: 'https://imgur.com/N6vhJmN',
            dynamic: true,
            size: 512
        })
        ...
        if(!oldMember.premiumSince && newMember.premiumSince) {
            ...
            Thankyou.setDescription(`Merci à toi d'avoir booster le serveur !`)
            ...
            Thankyou.setDescription(`Merci d'avoir boosté le serveur ! Votre soutien est très apprécié.`)
